...
- If Gemini is installed but not authenticated, advise the user to run `gemini` interactively to authenticate, or set the `GEMINI_API_KEY` environment variable.
