...
argument-hint: '[--wait|--background] [--base <ref>] [--scope auto|working-tree|branch] [-m <model>] [focus ...]'
...
- Unlike `/gemini:review`, this command supports extra focus text after the flags.
